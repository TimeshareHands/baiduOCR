...
百度OCR插件,该插件支持android,ios . iOS的ocr库包.支持模拟器的.上传至AppStore前，必须使用lipo命令移除模拟器架构。[FAQ.2](https://cloud.baidu.com/doc/OCR/OCR-iOS-SDK.html#.2F.CA.88.72.AF.63.B5.6C.D6.D1.39.1E.60.F0.8C.6B)
